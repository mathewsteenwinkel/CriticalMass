        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> Chicago, IL</p>
              <p className='address-street'> 60601, USA</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'>San Jose, CA</p>
              <p className='address-street'> 95113, USA</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> London, GB</p>
              <p className='address-street'> SE1 0SW, UK</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> Los Angeles, CA</p>
              <p className='address-street'> 90066, USA</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> Franklin, TN</p>
              <p className='address-street'> 37067, USA</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> New York, NY</p>
              <p className='address-street'> 10014, USA</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> Barreal, CR</p>
              <p className='address-street'> 40104, Costa Rica</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> Pinheiro, BR</p>
              <p className='address-street'> CEP 05413-909, Brazil</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='loaction-arrow'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> Minato City, Tokyo, JP</p>
              <p className='address-street'> 105-0023, Japan</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='loaction-arrow'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> </p>
              <p className='address-street'> Toronto, ON</p>
              <p className='address-street'> M4W 3G8, Canada</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='location-opening'>
        ...
        <div className='City'>
          ...
          <div className='Address'>
            ...
            <div className='Address-city'>
              ...
              <p className='address-street'> 3rd</p>
              <p className='address-street'> Vancouver, BC</p>
              <p className='address-street'> V5H 2Y3, Canada</p>
            </div>
          </div>
          <div className='location-jobs'>
            <div className='loaction-arrow'>
